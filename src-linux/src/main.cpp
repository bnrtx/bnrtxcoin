...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x00000995ccb2b2ca451acdd7d350d3d8c1768842ba48cb0e81cf2cf9ee4bb40b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BnrtxCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BnrtxCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
 ...
 static const int64 nTargetTimespan = 216000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000995ccb2b2ca451acdd7d350d3d8c1768842ba48cb0e81cf2cf9ee4bb40b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1429634704;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1366131;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BnrtxCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BnrtxCoinCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BnrtxCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("BnrtxCoin-miner");
    ...
    try { loop {
        ...
        printf("Running BnrtxCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BnrtxCoinMiner terminated\n");
        throw;
    }
}
